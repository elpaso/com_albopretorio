...
* @copyright    Copyright (C) 2015 Alessandro Pasotti http://www.itopen.it All rights reserved.
* @license      GNU/GPL
 ...
 * @since       1.0
 */
class AlbopretorioViewArchivio extends JViewLegacy
{
	/**
	 * @var     object
	 * @since   1.6
	...
	public function display($tpl = null)
	{
        ...
        // Point to standard template
		$this->addTemplatePath(  dirname(__FILE__) . '/../albopretorio/tmpl/');

        // Set FE filters
        $state = $this->get ( 'State' );

		$state->set ('filter.published', '2');
        $state->set ('filter.hide', 0);
