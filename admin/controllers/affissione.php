...
/**
 * Affissione controller class.
 *
 * @package     Joomla.Administrator
 * @subpackage  com_albopretorio
 * @since       1.6
 */
class AlbopretorioControllerAffissione extends JControllerForm
{
	/**
    ...
    protected $view_list = 'albopretorio';
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Affissione', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_albopretorio' . $this->getRedirectToListAppend(), false));
